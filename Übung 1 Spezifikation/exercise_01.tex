...
\textbf{Postconditions / Goal:} Der Benutzer kann seinen Benutzernamen, seine E-mail oder sein Passwort ändern.\\
\textbf{Postconditions Special Cases:} 
\begin{itemize}
    \item Die eingegebenen Daten für den Benutzernamen oder die E-Mail enthalten komische Umlaute
    	\item Benutzername oder E-Mail existieren bereits, siehe SQ-3.2 3a1
    	\item Das Passwort besteht den Sicherheitscheck nicht
    	\item Das Passwort wurde wiederholt falsch eingegeben
\end{itemize}
\textbf{Steps Default Case:}
\begin{enumerate}
    \item Benutzer wählt Persönliche Daten aus
    \item Benutzer wählt Benutzernamen, E-Mail oder Passwort bearbeiten aus
    \item Benutzer bearbeitet Benutzernamen, E-Mail oder Passwort
